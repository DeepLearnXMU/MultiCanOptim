...
def get_parser():
    ...
    parser.add_argument("--bleu_npy", type=str, default="",
                        help="Numpy array that stores BLEU score of each sentence")
    parser.add_argument("--dbleu_npy", type=str, default="",
                        help="Numpy array that stores div-BLEU score of each sentence")
    ...
    parser.add_argument("--sct_term", type=float, default=0.15,
                        help="Coefficient of BLEU loss and div-BLEU loss (0-1)")
    ...
    for _ in range(params.max_epoch):
        ...
        while trainer.n_sentences < trainer.epoch_size:
            ...
            for lang1, lang2 in shuf_order(params.mt_steps, params):
                trainer.mt_step(lang1, lang2, params.lambda_mt, params.bleu_npy, params.dbleu_npy)
